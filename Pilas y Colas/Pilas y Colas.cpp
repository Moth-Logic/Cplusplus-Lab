...
int main()
{
    ...
    cout << "\nCircle List (string)" << endl;
    CircleList<string>* lista = new CircleList<string>();

    lista->insert("manzana");
    lista->insertBack("sandia");
    lista->print();

    lista->insert("mango");
    lista->insertBack("pina");
    lista->print();
    ...
    cout << "Front: " << lista->getFront() << endl;
    cout << "Back: " << lista->getBack() << endl;

    lista->previous();
    lista->previous();
    lista->print();

    cout << "remove: " << lista->remove() << endl;
    lista->print();

    cout << "removeBack: " << lista->removeBack() << endl;
    lista->print();
    ...
    lista->insert("maranon");
    lista->insertBack("jocote");
    lista->insert("guayaba");
    lista->insertBack("yuplon");
    lista->insert("pitanga");
    lista->print();
